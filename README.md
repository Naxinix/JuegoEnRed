...
Una vez seleccionamos comenzar partida, el juego nos llevará a una pantalla de 'buscando partida', en la que nos mostrará un temporizador global y se esperará a jugadores para comenzar el juego. Puede haber un máximo de 20 y un mínimo de 5 jugadores en una partida.
...
Si el temporizador llega a 0 y hay menor que 5 personas el temporizador se reiniciará para esperar a jugadores.
