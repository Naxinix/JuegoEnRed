...
var counter = 0; //contador de carga de ultimate. 0-100
var text = 0;
var ultCharged = false;
var ultiTime = 0; //tiempo de duracion de la ulti
var ultused = false; //true si la ultimate ha sido usada. Se pone a false cuando ultTime llega a su máximo valor
...
Project.levelState.prototype = {
    ...
    create: function() {
        ...
        //loop de gestion del speedBoost
        ...
        game.world.bringToTop(text);
        //creacion de todo el polvo estelar
        ...
        //creacion de los todos los agujeros negros aplicando la misma técnica que con el polvo estelar
        for(m=0;m<10;m++){
        ...
        //se repiten los mismos procedimientos que con la nave jugador
        ...
        //claseDummy trackea al jugador. Esto es para que las pruebas sean mas completas
    ...
    update: function() {
        ...
        //COLISIONES
        //colisión de balas con nave dummy enemiga
        ...
        //colision de balas enemigas con nuestra nave
        ...
        //colision de balas con nave loot
        ...
        //Colisión y efecto con ultimate de strategist (-100 de vida al colisionar)
        for(j=0; j<10; j++){
        ...
        game.physics.arcade.overlap(spaceship,area,function(){isTrapped=true; game.world.moveUp(area);});
