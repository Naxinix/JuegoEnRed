...
//factor de conversion entre las coordenadas del mundo y las del minimapa
...
function setGrav(){
    ...
    area2 = game.add.sprite(game.world.centerX-250,game.world.centerY-250,'area2');
    game.world.sendToBack(area2);
    game.physics.enable(area2, Phaser.Physics.ARCADE);
    grav = game.add.sprite(game.world.centerX,game.world.centerY,'graviton');
